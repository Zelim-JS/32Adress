...
const deliveryItems = [
  ...
  {
    id: 2,
    name: "Цезарь с бараниной и грудкой на гриле",
    img: "https://eda.yandex/images/1380298/9057ba70a760213ab552e93eebc57969-450x300.jpg",
    count: 1,
    price: 200,
  },
  {
...
export function DeliveryPage({
  ...
  return (
    <div className="delivery-page-wrapper">
      {cartItems.length > 0 && (
        <CartButton countOfItems={countOfItems} openCart={openCart} />
      )}
      {showCart && (
        <CartFull
